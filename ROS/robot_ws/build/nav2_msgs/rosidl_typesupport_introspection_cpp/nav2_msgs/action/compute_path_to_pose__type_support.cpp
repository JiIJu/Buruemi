...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ComputePathToPose_Goal_message_member_array[1] = {
  {
    "pose",  // name
    ...
    offsetof(nav2_msgs::action::ComputePathToPose_Goal, pose),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ComputePathToPose_Result_message_member_array[1] = {
  {
    "path",  // name
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<nav2_msgs::msg::Path>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
