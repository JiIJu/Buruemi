...
#ifndef NAV2_MSGS__MSG__VOXEL_GRID__STRUCT_HPP_
#define NAV2_MSGS__MSG__VOXEL_GRID__STRUCT_HPP_
...
struct VoxelGrid_
{
  ...
  explicit VoxelGrid_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_init),
    origin(_init),
    resolutions(_init)
  {
  ...
  explicit VoxelGrid_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_alloc, _init),
    origin(_alloc, _init),
...
#endif  // NAV2_MSGS__MSG__VOXEL_GRID__STRUCT_HPP_
