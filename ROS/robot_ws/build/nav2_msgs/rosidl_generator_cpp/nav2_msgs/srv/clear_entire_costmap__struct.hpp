...
#ifndef NAV2_MSGS__SRV__CLEAR_ENTIRE_COSTMAP__STRUCT_HPP_
#define NAV2_MSGS__SRV__CLEAR_ENTIRE_COSTMAP__STRUCT_HPP_
...
struct ClearEntireCostmap_Request_
{
  ...
  explicit ClearEntireCostmap_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : request(_init)
  {
    (void)_init;
  }

  explicit ClearEntireCostmap_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
struct ClearEntireCostmap_Response_
{
  ...
  explicit ClearEntireCostmap_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : response(_init)
  {
    (void)_init;
  }

  explicit ClearEntireCostmap_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // NAV2_MSGS__SRV__CLEAR_ENTIRE_COSTMAP__STRUCT_HPP_
