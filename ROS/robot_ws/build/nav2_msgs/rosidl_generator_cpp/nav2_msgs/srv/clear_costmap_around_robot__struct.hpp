...
#ifndef NAV2_MSGS__SRV__CLEAR_COSTMAP_AROUND_ROBOT__STRUCT_HPP_
#define NAV2_MSGS__SRV__CLEAR_COSTMAP_AROUND_ROBOT__STRUCT_HPP_
...
struct ClearCostmapAroundRobot_Request_
{
  ...
  explicit ClearCostmapAroundRobot_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
    {
      this->window_size_x = 0.0f;
      this->window_size_y = 0.0f;
    }
  }

  explicit ClearCostmapAroundRobot_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
  ...
  using _window_size_x_type =
    float;
  _window_size_x_type window_size_x;
  using _window_size_y_type =
    float;
  _window_size_y_type window_size_y;

  // setters for named parameter idiom
  Type & set__window_size_x(
    const float & _arg)
  {
    this->window_size_x = _arg;
    return *this;
  }
  Type & set__window_size_y(
    const float & _arg)
  {
    this->window_size_y = _arg;
    return *this;
  }
  ...
  {
    if (this->window_size_x != other.window_size_x) {
      return false;
    }
    if (this->window_size_y != other.window_size_y) {
      return false;
    }
    return true;
  }
...
struct ClearCostmapAroundRobot_Response_
{
  ...
  explicit ClearCostmapAroundRobot_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : response(_init)
  {
    (void)_init;
  }

  explicit ClearCostmapAroundRobot_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // NAV2_MSGS__SRV__CLEAR_COSTMAP_AROUND_ROBOT__STRUCT_HPP_
