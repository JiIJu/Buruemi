...
#include "nav2_msgs/action/follow_path__rosidl_typesupport_fastrtps_c.h"
...
{
  return max_serialized_size_nav2_msgs__action__FollowPath_Goal(
    full_bounded, 0);
}
...
{
  return max_serialized_size_nav2_msgs__action__FollowPath_Result(
    full_bounded, 0);
}
...
{
  return max_serialized_size_nav2_msgs__action__FollowPath_Feedback(
    full_bounded, 0);
}
...
// already included above
// #include "nav2_msgs/action/follow_path__functions.h"  // goal
...
{
  return max_serialized_size_nav2_msgs__action__FollowPath_SendGoal_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_nav2_msgs__action__FollowPath_SendGoal_Response(
    full_bounded, 0);
}
...
{
  return max_serialized_size_nav2_msgs__action__FollowPath_GetResult_Request(
    full_bounded, 0);
}
...
// already included above
// #include "nav2_msgs/action/follow_path__functions.h"  // result
...
{
  return max_serialized_size_nav2_msgs__action__FollowPath_GetResult_Response(
    full_bounded, 0);
}
...
// already included above
// #include "nav2_msgs/action/follow_path__functions.h"  // feedback
// already included above
// #include "unique_identifier_msgs/msg/uuid__functions.h"  // goal_id
...
{
  return max_serialized_size_nav2_msgs__action__FollowPath_FeedbackMessage(
    full_bounded, 0);
}
