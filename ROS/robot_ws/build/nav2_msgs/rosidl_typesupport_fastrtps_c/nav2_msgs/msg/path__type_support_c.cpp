...
#include "nav2_msgs/msg/path__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/pose__functions.h"  // poses
...
using _Path__ros_msg_type = nav2_msgs__msg__Path;
...
static uint32_t _Path__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_nav2_msgs__msg__Path(
...
{
  return max_serialized_size_nav2_msgs__msg__Path(
    full_bounded, 0);
}
