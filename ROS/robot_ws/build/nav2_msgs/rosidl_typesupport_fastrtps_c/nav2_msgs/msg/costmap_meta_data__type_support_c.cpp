...
#include "nav2_msgs/msg/costmap_meta_data__rosidl_typesupport_fastrtps_c.h"
...
#include "builtin_interfaces/msg/time__functions.h"  // map_load_time, update_time
#include "geometry_msgs/msg/pose__functions.h"  // origin
#include "rosidl_generator_c/string.h"  // layer
#include "rosidl_generator_c/string_functions.h"  // layer
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: layer
  {
    const rosidl_generator_c__String * str = &ros_message->layer;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: layer
  {
    ...
    if (!ros_message->layer.data) {
      rosidl_generator_c__String__init(&ros_message->layer);
    }
...
{
  return max_serialized_size_nav2_msgs__msg__CostmapMetaData(
    full_bounded, 0);
}
