...
#include "nav2_msgs/msg/costmap__rosidl_typesupport_fastrtps_c.h"
...
#include "nav2_msgs/msg/costmap_meta_data__functions.h"  // metadata
...
{
  return max_serialized_size_nav2_msgs__msg__Costmap(
    full_bounded, 0);
}
