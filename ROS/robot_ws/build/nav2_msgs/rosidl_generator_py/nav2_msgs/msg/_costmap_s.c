...
bool nav2_msgs__msg__costmap__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "nav2_msgs.msg._costmap.Costmap",
        full_classname_dest, 30) == 0);
  }
  nav2_msgs__msg__Costmap * ros_message = _ros_message;
  {  // header
  ...
  {  // metadata
    ...
    if (!nav2_msgs__msg__costmap_meta_data__convert_from_py(field, &ros_message->metadata)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of Costmap */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("nav2_msgs.msg._costmap");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Costmap");
  ...
  {  // metadata
    PyObject * field = NULL;
    field = nav2_msgs__msg__costmap_meta_data__convert_to_py(&ros_message->metadata);
    if (!field) {
      return NULL;
    }
    {
