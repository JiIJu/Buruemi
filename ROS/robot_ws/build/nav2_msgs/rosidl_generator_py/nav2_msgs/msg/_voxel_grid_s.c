...
bool nav2_msgs__msg__voxel_grid__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "nav2_msgs.msg._voxel_grid.VoxelGrid",
        full_classname_dest, 35) == 0);
  }
  nav2_msgs__msg__VoxelGrid * ros_message = _ros_message;
  {  // header
  ...
  {  // origin
    ...
    if (!geometry_msgs__msg__point32__convert_from_py(field, &ros_message->origin)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // resolutions
    ...
    if (!geometry_msgs__msg__vector3__convert_from_py(field, &ros_message->resolutions)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // size_z
    ...
    assert(PyLong_Check(field));
    ros_message->size_z = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of VoxelGrid */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("nav2_msgs.msg._voxel_grid");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VoxelGrid");
  ...
  {  // origin
    PyObject * field = NULL;
    field = geometry_msgs__msg__point32__convert_to_py(&ros_message->origin);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // resolutions
    PyObject * field = NULL;
    field = geometry_msgs__msg__vector3__convert_to_py(&ros_message->resolutions);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // size_z
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->size_z);
    {
