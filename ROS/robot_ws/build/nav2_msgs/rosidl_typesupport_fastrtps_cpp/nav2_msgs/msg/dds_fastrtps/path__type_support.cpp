...
#include "nav2_msgs/msg/path__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const nav2_msgs::msg::Path & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  nav2_msgs::msg::Path & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const nav2_msgs::msg::Path *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<nav2_msgs::msg::Path *>(
    untyped_ros_message);
...
{
  return &nav2_msgs::msg::typesupport_fastrtps_cpp::_Path__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nav2_msgs, msg, Path)() {
  return &nav2_msgs::msg::typesupport_fastrtps_cpp::_Path__handle;
}
