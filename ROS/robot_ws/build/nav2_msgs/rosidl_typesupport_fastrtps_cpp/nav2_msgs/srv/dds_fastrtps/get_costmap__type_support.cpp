...
#include "nav2_msgs/srv/get_costmap__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  return max_serialized_size_GetCostmap_Request(full_bounded, 0);
}
...
{
  return max_serialized_size_GetCostmap_Response(full_bounded, 0);
}
