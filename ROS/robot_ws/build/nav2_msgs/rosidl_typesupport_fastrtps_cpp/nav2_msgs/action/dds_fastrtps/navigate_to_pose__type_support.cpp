...
#include "nav2_msgs/action/navigate_to_pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const nav2_msgs::action::NavigateToPose_Goal &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
{
bool cdr_serialize(
  const nav2_msgs::action::NavigateToPose_Result &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
{
bool cdr_serialize(
  const nav2_msgs::action::NavigateToPose_Feedback &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
