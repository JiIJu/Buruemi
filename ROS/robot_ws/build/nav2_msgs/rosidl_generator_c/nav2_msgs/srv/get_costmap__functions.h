...
#ifndef NAV2_MSGS__SRV__GET_COSTMAP__FUNCTIONS_H_
#define NAV2_MSGS__SRV__GET_COSTMAP__FUNCTIONS_H_
...
/// Initialize srv/GetCostmap message.
/**
...
/// Finalize srv/GetCostmap message.
/**
...
/// Create srv/GetCostmap message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * nav2_msgs__srv__GetCostmap_Request__init().
...
/// Destroy srv/GetCostmap message.
/**
 * It calls
 * nav2_msgs__srv__GetCostmap_Request__fini()
...
/// Initialize array of srv/GetCostmap messages.
/**
...
/// Finalize array of srv/GetCostmap messages.
/**
 * It calls
 * nav2_msgs__srv__GetCostmap_Request__fini()
...
/// Create array of srv/GetCostmap messages.
/**
...
/// Destroy array of srv/GetCostmap messages.
/**
 * It calls
 * nav2_msgs__srv__GetCostmap_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * nav2_msgs__srv__GetCostmap_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_nav2_msgs
...
/**
 * It calls
 * nav2_msgs__srv__GetCostmap_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_nav2_msgs
...
/**
 * It calls
 * nav2_msgs__srv__GetCostmap_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // NAV2_MSGS__SRV__GET_COSTMAP__FUNCTIONS_H_
