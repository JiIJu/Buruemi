...
#include <stddef.h>
#include "dwb_msgs/srv/get_critic_score__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__ServiceMembers dwb_msgs__srv__get_critic_score__rosidl_typesupport_introspection_c__GetCriticScore_service_members = {
  "dwb_msgs__srv",  // service namespace
  "GetCriticScore",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // dwb_msgs__srv__get_critic_score__rosidl_typesupport_introspection_c__GetCriticScore_Request_message_type_support_handle,
  NULL  // response message
  // dwb_msgs__srv__get_critic_score__rosidl_typesupport_introspection_c__GetCriticScore_Response_message_type_support_handle
};

static rosidl_service_type_support_t dwb_msgs__srv__get_critic_score__rosidl_typesupport_introspection_c__GetCriticScore_service_type_support_handle = {
  0,
  &dwb_msgs__srv__get_critic_score__rosidl_typesupport_introspection_c__GetCriticScore_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dwb_msgs, srv, GetCriticScore)() {
  if (!dwb_msgs__srv__get_critic_score__rosidl_typesupport_introspection_c__GetCriticScore_service_type_support_handle.typesupport_identifier) {
    dwb_msgs__srv__get_critic_score__rosidl_typesupport_introspection_c__GetCriticScore_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)dwb_msgs__srv__get_critic_score__rosidl_typesupport_introspection_c__GetCriticScore_service_type_support_handle.data;
  ...
  return &dwb_msgs__srv__get_critic_score__rosidl_typesupport_introspection_c__GetCriticScore_service_type_support_handle;
}
