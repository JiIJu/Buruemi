...
#include "dwb_msgs/srv/generate_trajectory__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/pose2_d__functions.h"  // start_pose
#include "nav_2d_msgs/msg/twist2_d__functions.h"  // cmd_vel, start_vel
  ...
  void * untyped_ros_message)
{
  ...
  _GenerateTrajectory_Request__ros_msg_type * ros_message = static_cast<_GenerateTrajectory_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: start_pose
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
{
  return max_serialized_size_dwb_msgs__srv__GenerateTrajectory_Request(
    full_bounded, 0);
}
...
#include "dwb_msgs/msg/trajectory2_d__functions.h"  // traj
  ...
  void * untyped_ros_message)
{
  ...
  _GenerateTrajectory_Response__ros_msg_type * ros_message = static_cast<_GenerateTrajectory_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: traj
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
{
  return max_serialized_size_dwb_msgs__srv__GenerateTrajectory_Response(
    full_bounded, 0);
}
