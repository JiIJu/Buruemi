...
#include "dwb_msgs/srv/generate_twists__rosidl_typesupport_fastrtps_c.h"
...
#include "nav_2d_msgs/msg/twist2_d__functions.h"  // current_vel
...
{
  return max_serialized_size_dwb_msgs__srv__GenerateTwists_Request(
    full_bounded, 0);
}
...
// already included above
// #include "nav_2d_msgs/msg/twist2_d__functions.h"  // twists
...
{
  return max_serialized_size_dwb_msgs__srv__GenerateTwists_Response(
    full_bounded, 0);
}
