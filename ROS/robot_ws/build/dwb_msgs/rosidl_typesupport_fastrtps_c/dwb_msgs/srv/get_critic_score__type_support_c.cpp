...
#include "dwb_msgs/srv/get_critic_score__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_generator_c/string.h"  // critic_name
#include "rosidl_generator_c/string_functions.h"  // critic_name
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->critic_name;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: critic_name
  {
    ...
    if (!ros_message->critic_name.data) {
      rosidl_generator_c__String__init(&ros_message->critic_name);
    }
...
#include "dwb_msgs/msg/critic_score__functions.h"  // score
