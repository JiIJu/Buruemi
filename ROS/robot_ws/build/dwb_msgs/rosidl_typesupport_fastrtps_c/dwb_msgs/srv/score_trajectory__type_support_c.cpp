...
#include "dwb_msgs/srv/score_trajectory__rosidl_typesupport_fastrtps_c.h"
...
#include "nav_2d_msgs/msg/path2_d__functions.h"  // global_plan
#include "nav_2d_msgs/msg/pose2_d_stamped__functions.h"  // pose
#include "nav_2d_msgs/msg/twist2_d__functions.h"  // velocity
...
static size_t _ScoreTrajectory_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_dwb_msgs__srv__ScoreTrajectory_Request(
    full_bounded, 0);
}
...
#include "dwb_msgs/msg/trajectory_score__functions.h"  // score
...
static size_t _ScoreTrajectory_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_dwb_msgs__srv__ScoreTrajectory_Response(
    full_bounded, 0);
}
