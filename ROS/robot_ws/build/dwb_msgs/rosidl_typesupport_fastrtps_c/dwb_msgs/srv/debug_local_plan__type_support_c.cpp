...
#include "dwb_msgs/srv/debug_local_plan__rosidl_typesupport_fastrtps_c.h"
...
{
  return max_serialized_size_dwb_msgs__srv__DebugLocalPlan_Request(
    full_bounded, 0);
}
...
#include "dwb_msgs/msg/local_plan_evaluation__functions.h"  // results
...
{
  return max_serialized_size_dwb_msgs__srv__DebugLocalPlan_Response(
    full_bounded, 0);
}
