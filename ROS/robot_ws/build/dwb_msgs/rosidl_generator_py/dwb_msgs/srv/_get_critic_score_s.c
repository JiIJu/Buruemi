...
bool dwb_msgs__srv__get_critic_score__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "dwb_msgs.srv._get_critic_score.GetCriticScore_Request",
  ...
  {  // critic_name
    ...
    rosidl_generator_c__String__assign(&ros_message->critic_name, PyBytes_AS_STRING(encoded_field));
...
bool dwb_msgs__srv__get_critic_score__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "dwb_msgs.srv._get_critic_score.GetCriticScore_Response",
