...
static const _GetCriticScore_Request_type_support_symbol_names_t _GetCriticScore_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dwb_msgs, srv, GetCriticScore_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dwb_msgs, srv, GetCriticScore_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dwb_msgs, srv, GetCriticScore_Request)() {
  return &::dwb_msgs::srv::rosidl_typesupport_c::GetCriticScore_Request_message_type_support_handle;
}
...
static const _GetCriticScore_Response_type_support_symbol_names_t _GetCriticScore_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dwb_msgs, srv, GetCriticScore_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dwb_msgs, srv, GetCriticScore_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_dwb_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dwb_msgs, srv, GetCriticScore_Response)() {
  return &::dwb_msgs::srv::rosidl_typesupport_c::GetCriticScore_Response_message_type_support_handle;
}
...
static const _GetCriticScore_type_support_symbol_names_t _GetCriticScore_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dwb_msgs, srv, GetCriticScore)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dwb_msgs, srv, GetCriticScore)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, dwb_msgs, srv, GetCriticScore)() {
  return &::dwb_msgs::srv::rosidl_typesupport_c::GetCriticScore_service_type_support_handle;
}
