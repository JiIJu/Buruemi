...
static const _GenerateTrajectory_Request_type_support_symbol_names_t _GenerateTrajectory_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dwb_msgs, srv, GenerateTrajectory_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dwb_msgs, srv, GenerateTrajectory_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dwb_msgs, srv, GenerateTrajectory_Request)() {
  return &::dwb_msgs::srv::rosidl_typesupport_c::GenerateTrajectory_Request_message_type_support_handle;
}
...
static const _GenerateTrajectory_Response_type_support_symbol_names_t _GenerateTrajectory_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dwb_msgs, srv, GenerateTrajectory_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dwb_msgs, srv, GenerateTrajectory_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_dwb_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dwb_msgs, srv, GenerateTrajectory_Response)() {
  return &::dwb_msgs::srv::rosidl_typesupport_c::GenerateTrajectory_Response_message_type_support_handle;
}
...
static const _GenerateTrajectory_type_support_symbol_names_t _GenerateTrajectory_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dwb_msgs, srv, GenerateTrajectory)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dwb_msgs, srv, GenerateTrajectory)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, dwb_msgs, srv, GenerateTrajectory)() {
  return &::dwb_msgs::srv::rosidl_typesupport_c::GenerateTrajectory_service_type_support_handle;
}
