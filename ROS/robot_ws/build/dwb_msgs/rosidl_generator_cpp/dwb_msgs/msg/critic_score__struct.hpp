...
#ifndef DWB_MSGS__MSG__CRITIC_SCORE__STRUCT_HPP_
#define DWB_MSGS__MSG__CRITIC_SCORE__STRUCT_HPP_
...
struct CriticScore_
{
  ...
  explicit CriticScore_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit CriticScore_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : name(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // DWB_MSGS__MSG__CRITIC_SCORE__STRUCT_HPP_
