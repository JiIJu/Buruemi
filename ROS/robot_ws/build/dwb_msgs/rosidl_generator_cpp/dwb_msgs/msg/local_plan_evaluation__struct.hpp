...
#ifndef DWB_MSGS__MSG__LOCAL_PLAN_EVALUATION__STRUCT_HPP_
#define DWB_MSGS__MSG__LOCAL_PLAN_EVALUATION__STRUCT_HPP_
...
// Member 'twists'
#include "dwb_msgs/msg/trajectory_score__struct.hpp"
...
struct LocalPlanEvaluation_
{
  ...
  explicit LocalPlanEvaluation_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_init)
  {
  ...
  explicit LocalPlanEvaluation_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_alloc, _init)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
  ...
  _header_type header;
  using _twists_type =
    std::vector<dwb_msgs::msg::TrajectoryScore_<ContainerAllocator>, typename ContainerAllocator::template rebind<dwb_msgs::msg::TrajectoryScore_<ContainerAllocator>>::other>;
  _twists_type twists;
  ...
  Type & set__twists(
    const std::vector<dwb_msgs::msg::TrajectoryScore_<ContainerAllocator>, typename ContainerAllocator::template rebind<dwb_msgs::msg::TrajectoryScore_<ContainerAllocator>>::other> & _arg)
  {
    this->twists = _arg;
    return *this;
  }
...
#endif  // DWB_MSGS__MSG__LOCAL_PLAN_EVALUATION__STRUCT_HPP_
