...
#ifndef DWB_MSGS__SRV__SCORE_TRAJECTORY__STRUCT_HPP_
#define DWB_MSGS__SRV__SCORE_TRAJECTORY__STRUCT_HPP_
...
struct ScoreTrajectory_Request_
{
  ...
  explicit ScoreTrajectory_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : pose(_init),
    velocity(_init),
    global_plan(_init),
    traj(_init)
  ...
  explicit ScoreTrajectory_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : pose(_alloc, _init),
...
struct ScoreTrajectory_Response_
{
  ...
  explicit ScoreTrajectory_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : score(_init)
  {
    (void)_init;
  }

  explicit ScoreTrajectory_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : score(_alloc, _init)
  {
    (void)_init;
  }
...
#endif  // DWB_MSGS__SRV__SCORE_TRAJECTORY__STRUCT_HPP_
