...
#ifndef DWB_MSGS__SRV__GENERATE_TWISTS__STRUCT_HPP_
#define DWB_MSGS__SRV__GENERATE_TWISTS__STRUCT_HPP_
...
struct GenerateTwists_Request_
{
  ...
  explicit GenerateTwists_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : current_vel(_init)
  {
    (void)_init;
  }

  explicit GenerateTwists_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
struct GenerateTwists_Response_
{
  ...
  explicit GenerateTwists_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_init;
  }

  explicit GenerateTwists_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_init;
    (void)_alloc;
  }
  ...
  // field types and members
  using _twists_type =
    std::vector<nav_2d_msgs::msg::Twist2D_<ContainerAllocator>, typename ContainerAllocator::template rebind<nav_2d_msgs::msg::Twist2D_<ContainerAllocator>>::other>;
  _twists_type twists;

  // setters for named parameter idiom
  Type & set__twists(
    const std::vector<nav_2d_msgs::msg::Twist2D_<ContainerAllocator>, typename ContainerAllocator::template rebind<nav_2d_msgs::msg::Twist2D_<ContainerAllocator>>::other> & _arg)
  {
    this->twists = _arg;
    return *this;
  }
...
#endif  // DWB_MSGS__SRV__GENERATE_TWISTS__STRUCT_HPP_
