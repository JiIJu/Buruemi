...
#ifndef DWB_MSGS__SRV__GENERATE_TRAJECTORY__STRUCT_HPP_
#define DWB_MSGS__SRV__GENERATE_TRAJECTORY__STRUCT_HPP_
...
struct GenerateTrajectory_Request_
{
  ...
  explicit GenerateTrajectory_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : start_pose(_init),
    start_vel(_init),
    cmd_vel(_init)
  {
  ...
  explicit GenerateTrajectory_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
struct GenerateTrajectory_Response_
{
  ...
  explicit GenerateTrajectory_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : traj(_init)
  {
    (void)_init;
  }

  explicit GenerateTrajectory_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : traj(_alloc, _init)
  {
    (void)_init;
  }
...
#endif  // DWB_MSGS__SRV__GENERATE_TRAJECTORY__STRUCT_HPP_
