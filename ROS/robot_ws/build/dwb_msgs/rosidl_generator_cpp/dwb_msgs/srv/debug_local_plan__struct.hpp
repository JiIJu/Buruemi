...
#ifndef DWB_MSGS__SRV__DEBUG_LOCAL_PLAN__STRUCT_HPP_
#define DWB_MSGS__SRV__DEBUG_LOCAL_PLAN__STRUCT_HPP_
...
struct DebugLocalPlan_Request_
{
  ...
  explicit DebugLocalPlan_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : pose(_init),
    velocity(_init),
    global_plan(_init)
  {
  ...
  explicit DebugLocalPlan_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : pose(_alloc, _init),
...
struct DebugLocalPlan_Response_
{
  ...
  explicit DebugLocalPlan_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : results(_init)
  {
    (void)_init;
  }

  explicit DebugLocalPlan_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // DWB_MSGS__SRV__DEBUG_LOCAL_PLAN__STRUCT_HPP_
