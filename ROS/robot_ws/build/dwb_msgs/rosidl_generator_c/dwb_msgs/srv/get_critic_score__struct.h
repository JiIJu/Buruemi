...
#ifndef DWB_MSGS__SRV__GET_CRITIC_SCORE__STRUCT_H_
#define DWB_MSGS__SRV__GET_CRITIC_SCORE__STRUCT_H_
...
typedef struct dwb_msgs__srv__GetCriticScore_Request
{
  ...
  rosidl_generator_c__String critic_name;
...
#endif  // DWB_MSGS__SRV__GET_CRITIC_SCORE__STRUCT_H_
