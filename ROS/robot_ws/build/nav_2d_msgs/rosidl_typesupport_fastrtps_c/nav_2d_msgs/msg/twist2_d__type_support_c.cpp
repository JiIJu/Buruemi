...
#include "nav_2d_msgs/msg/twist2_d__rosidl_typesupport_fastrtps_c.h"
...
using _Twist2D__ros_msg_type = nav_2d_msgs__msg__Twist2D;
...
static uint32_t _Twist2D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_nav_2d_msgs__msg__Twist2D(
...
{
  return max_serialized_size_nav_2d_msgs__msg__Twist2D(
    full_bounded, 0);
}
