...
#include "nav_2d_msgs/msg/pose2_d_stamped__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/pose2_d__functions.h"  // pose
  ...
  void * untyped_ros_message)
{
  ...
  _Pose2DStamped__ros_msg_type * ros_message = static_cast<_Pose2DStamped__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static size_t _Pose2DStamped__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_nav_2d_msgs__msg__Pose2DStamped(
    full_bounded, 0);
}
