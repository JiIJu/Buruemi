...
#include "nav_2d_msgs/msg/path2_d__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/pose2_d__functions.h"  // poses
  ...
  void * untyped_ros_message)
{
  ...
  _Path2D__ros_msg_type * ros_message = static_cast<_Path2D__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
{
  return max_serialized_size_nav_2d_msgs__msg__Path2D(
    full_bounded, 0);
}
