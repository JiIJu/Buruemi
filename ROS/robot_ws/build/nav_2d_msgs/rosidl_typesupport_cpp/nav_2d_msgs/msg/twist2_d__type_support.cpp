...
static const _Twist2D_type_support_symbol_names_t _Twist2D_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nav_2d_msgs, msg, Twist2D)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, nav_2d_msgs, msg, Twist2D)),
  }
};
...
{
  return &::nav_2d_msgs::msg::rosidl_typesupport_cpp::Twist2D_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, nav_2d_msgs, msg, Twist2D)() {
  return get_message_type_support_handle<nav_2d_msgs::msg::Twist2D>();
}
