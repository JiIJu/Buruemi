...
bool nav_2d_msgs__msg__pose2_d_stamped__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "nav_2d_msgs.msg._pose2_d_stamped.Pose2DStamped",
        full_classname_dest, 46) == 0);
  }
  nav_2d_msgs__msg__Pose2DStamped * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of Pose2DStamped */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("nav_2d_msgs.msg._pose2_d_stamped");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Pose2DStamped");
