...
#ifndef NAV_2D_MSGS__MSG__TWIST2_D_STAMPED__STRUCT_HPP_
#define NAV_2D_MSGS__MSG__TWIST2_D_STAMPED__STRUCT_HPP_
...
struct Twist2DStamped_
{
  ...
  explicit Twist2DStamped_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_init),
    velocity(_init)
  {
    (void)_init;
  ...
  explicit Twist2DStamped_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_alloc, _init),
...
#endif  // NAV_2D_MSGS__MSG__TWIST2_D_STAMPED__STRUCT_HPP_
