...
#ifndef NAV_2D_MSGS__MSG__POSE2_D_STAMPED__STRUCT_HPP_
#define NAV_2D_MSGS__MSG__POSE2_D_STAMPED__STRUCT_HPP_
...
struct Pose2DStamped_
{
  ...
  explicit Pose2DStamped_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_init),
    pose(_init)
  {
    (void)_init;
  ...
  explicit Pose2DStamped_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_alloc, _init),
    pose(_alloc, _init)
  {
    (void)_init;
...
#endif  // NAV_2D_MSGS__MSG__POSE2_D_STAMPED__STRUCT_HPP_
