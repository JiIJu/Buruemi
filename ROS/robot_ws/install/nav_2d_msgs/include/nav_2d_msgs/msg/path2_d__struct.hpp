...
#ifndef NAV_2D_MSGS__MSG__PATH2_D__STRUCT_HPP_
#define NAV_2D_MSGS__MSG__PATH2_D__STRUCT_HPP_
...
struct Path2D_
{
  ...
  explicit Path2D_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_init)
  {
    (void)_init;
  }

  explicit Path2D_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_alloc, _init)
  {
    (void)_init;
  }
...
#endif  // NAV_2D_MSGS__MSG__PATH2_D__STRUCT_HPP_
