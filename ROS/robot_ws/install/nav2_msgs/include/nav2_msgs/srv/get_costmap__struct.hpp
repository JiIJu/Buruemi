...
#ifndef NAV2_MSGS__SRV__GET_COSTMAP__STRUCT_HPP_
#define NAV2_MSGS__SRV__GET_COSTMAP__STRUCT_HPP_
...
struct GetCostmap_Request_
{
  ...
  explicit GetCostmap_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : specs(_init)
  {
    (void)_init;
  }

  explicit GetCostmap_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : specs(_alloc, _init)
  {
    (void)_init;
  }
...
struct GetCostmap_Response_
{
  ...
  explicit GetCostmap_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : map(_init)
  {
    (void)_init;
  }

  explicit GetCostmap_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : map(_alloc, _init)
  {
    (void)_init;
  }
...
#endif  // NAV2_MSGS__SRV__GET_COSTMAP__STRUCT_HPP_
