...
#ifndef NAV2_MSGS__SRV__CLEAR_COSTMAP_EXCEPT_REGION__STRUCT_HPP_
#define NAV2_MSGS__SRV__CLEAR_COSTMAP_EXCEPT_REGION__STRUCT_HPP_
...
struct ClearCostmapExceptRegion_Request_
{
  ...
  explicit ClearCostmapExceptRegion_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit ClearCostmapExceptRegion_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
struct ClearCostmapExceptRegion_Response_
{
  ...
  explicit ClearCostmapExceptRegion_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : response(_init)
  {
    (void)_init;
  }

  explicit ClearCostmapExceptRegion_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // NAV2_MSGS__SRV__CLEAR_COSTMAP_EXCEPT_REGION__STRUCT_HPP_
