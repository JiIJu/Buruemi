...
#ifndef NAV2_MSGS__MSG__COSTMAP_META_DATA__STRUCT_H_
#define NAV2_MSGS__MSG__COSTMAP_META_DATA__STRUCT_H_
...
typedef struct nav2_msgs__msg__CostmapMetaData
{
  ...
  rosidl_generator_c__String layer;
  float resolution;
  uint32_t size_x;
  uint32_t size_y;
...
#endif  // NAV2_MSGS__MSG__COSTMAP_META_DATA__STRUCT_H_
