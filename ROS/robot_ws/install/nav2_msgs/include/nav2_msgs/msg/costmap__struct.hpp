...
#ifndef NAV2_MSGS__MSG__COSTMAP__STRUCT_HPP_
#define NAV2_MSGS__MSG__COSTMAP__STRUCT_HPP_
...
struct Costmap_
{
  ...
  explicit Costmap_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_init),
    metadata(_init)
  {
    (void)_init;
  ...
  explicit Costmap_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_alloc, _init),
...
#endif  // NAV2_MSGS__MSG__COSTMAP__STRUCT_HPP_
