...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Path_message_member_array[2] = {
  {
    ...
    offsetof(nav2_msgs::msg::Path, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(nav2_msgs::msg::Path, poses),  // bytes offset in struct
    nullptr,  // default value
...
{
  return &::nav2_msgs::msg::rosidl_typesupport_introspection_cpp::Path_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, nav2_msgs, msg, Path)() {
  return &::nav2_msgs::msg::rosidl_typesupport_introspection_cpp::Path_message_type_support_handle;
}
