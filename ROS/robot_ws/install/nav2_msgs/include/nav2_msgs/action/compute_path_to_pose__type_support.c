...
#include <stddef.h>
#include "nav2_msgs/action/compute_path_to_pose__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember ComputePathToPose_Goal__rosidl_typesupport_introspection_c__ComputePathToPose_Goal_message_member_array[1] = {
  {
    "pose",  // name
    ...
    offsetof(nav2_msgs__action__ComputePathToPose_Goal, pose),  // bytes offset in struct
    NULL,  // default value
...
static rosidl_typesupport_introspection_c__MessageMember ComputePathToPose_Result__rosidl_typesupport_introspection_c__ComputePathToPose_Result_message_member_array[1] = {
  {
    "path",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
...
static rosidl_typesupport_introspection_c__ServiceMembers nav2_msgs__action__compute_path_to_pose__rosidl_typesupport_introspection_c__ComputePathToPose_SendGoal_service_members = {
  "nav2_msgs__action",  // service namespace
  "ComputePathToPose_SendGoal",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // nav2_msgs__action__compute_path_to_pose__rosidl_typesupport_introspection_c__ComputePathToPose_SendGoal_Request_message_type_support_handle,
  NULL  // response message
  // nav2_msgs__action__compute_path_to_pose__rosidl_typesupport_introspection_c__ComputePathToPose_SendGoal_Response_message_type_support_handle
};

static rosidl_service_type_support_t nav2_msgs__action__compute_path_to_pose__rosidl_typesupport_introspection_c__ComputePathToPose_SendGoal_service_type_support_handle = {
  0,
  &nav2_msgs__action__compute_path_to_pose__rosidl_typesupport_introspection_c__ComputePathToPose_SendGoal_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nav2_msgs, action, ComputePathToPose_SendGoal)() {
  if (!nav2_msgs__action__compute_path_to_pose__rosidl_typesupport_introspection_c__ComputePathToPose_SendGoal_service_type_support_handle.typesupport_identifier) {
    nav2_msgs__action__compute_path_to_pose__rosidl_typesupport_introspection_c__ComputePathToPose_SendGoal_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)nav2_msgs__action__compute_path_to_pose__rosidl_typesupport_introspection_c__ComputePathToPose_SendGoal_service_type_support_handle.data;
  ...
  return &nav2_msgs__action__compute_path_to_pose__rosidl_typesupport_introspection_c__ComputePathToPose_SendGoal_service_type_support_handle;
}
...
// this is intentionally not const to allow initialization later to prevent an initialization race
static rosidl_typesupport_introspection_c__ServiceMembers nav2_msgs__action__compute_path_to_pose__rosidl_typesupport_introspection_c__ComputePathToPose_GetResult_service_members = {
  "nav2_msgs__action",  // service namespace
  "ComputePathToPose_GetResult",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // nav2_msgs__action__compute_path_to_pose__rosidl_typesupport_introspection_c__ComputePathToPose_GetResult_Request_message_type_support_handle,
  NULL  // response message
  // nav2_msgs__action__compute_path_to_pose__rosidl_typesupport_introspection_c__ComputePathToPose_GetResult_Response_message_type_support_handle
};

static rosidl_service_type_support_t nav2_msgs__action__compute_path_to_pose__rosidl_typesupport_introspection_c__ComputePathToPose_GetResult_service_type_support_handle = {
  0,
  &nav2_msgs__action__compute_path_to_pose__rosidl_typesupport_introspection_c__ComputePathToPose_GetResult_service_members,
  get_service_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nav2_msgs, action, ComputePathToPose_GetResult)() {
  if (!nav2_msgs__action__compute_path_to_pose__rosidl_typesupport_introspection_c__ComputePathToPose_GetResult_service_type_support_handle.typesupport_identifier) {
    nav2_msgs__action__compute_path_to_pose__rosidl_typesupport_introspection_c__ComputePathToPose_GetResult_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)nav2_msgs__action__compute_path_to_pose__rosidl_typesupport_introspection_c__ComputePathToPose_GetResult_service_type_support_handle.data;
  ...
  return &nav2_msgs__action__compute_path_to_pose__rosidl_typesupport_introspection_c__ComputePathToPose_GetResult_service_type_support_handle;
}
