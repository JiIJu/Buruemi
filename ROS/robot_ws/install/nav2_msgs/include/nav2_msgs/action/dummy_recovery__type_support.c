...
#include <stddef.h>
#include "nav2_msgs/action/dummy_recovery__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember DummyRecovery_Result__rosidl_typesupport_introspection_c__DummyRecovery_Result_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(nav2_msgs__action__DummyRecovery_Result, result),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static rosidl_typesupport_introspection_c__ServiceMembers nav2_msgs__action__dummy_recovery__rosidl_typesupport_introspection_c__DummyRecovery_SendGoal_service_members = {
  "nav2_msgs__action",  // service namespace
  "DummyRecovery_SendGoal",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // nav2_msgs__action__dummy_recovery__rosidl_typesupport_introspection_c__DummyRecovery_SendGoal_Request_message_type_support_handle,
  NULL  // response message
  // nav2_msgs__action__dummy_recovery__rosidl_typesupport_introspection_c__DummyRecovery_SendGoal_Response_message_type_support_handle
};

static rosidl_service_type_support_t nav2_msgs__action__dummy_recovery__rosidl_typesupport_introspection_c__DummyRecovery_SendGoal_service_type_support_handle = {
  0,
  &nav2_msgs__action__dummy_recovery__rosidl_typesupport_introspection_c__DummyRecovery_SendGoal_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nav2_msgs, action, DummyRecovery_SendGoal)() {
  if (!nav2_msgs__action__dummy_recovery__rosidl_typesupport_introspection_c__DummyRecovery_SendGoal_service_type_support_handle.typesupport_identifier) {
    nav2_msgs__action__dummy_recovery__rosidl_typesupport_introspection_c__DummyRecovery_SendGoal_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)nav2_msgs__action__dummy_recovery__rosidl_typesupport_introspection_c__DummyRecovery_SendGoal_service_type_support_handle.data;
  ...
  return &nav2_msgs__action__dummy_recovery__rosidl_typesupport_introspection_c__DummyRecovery_SendGoal_service_type_support_handle;
}
...
// this is intentionally not const to allow initialization later to prevent an initialization race
static rosidl_typesupport_introspection_c__ServiceMembers nav2_msgs__action__dummy_recovery__rosidl_typesupport_introspection_c__DummyRecovery_GetResult_service_members = {
  "nav2_msgs__action",  // service namespace
  "DummyRecovery_GetResult",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // nav2_msgs__action__dummy_recovery__rosidl_typesupport_introspection_c__DummyRecovery_GetResult_Request_message_type_support_handle,
  NULL  // response message
  // nav2_msgs__action__dummy_recovery__rosidl_typesupport_introspection_c__DummyRecovery_GetResult_Response_message_type_support_handle
};

static rosidl_service_type_support_t nav2_msgs__action__dummy_recovery__rosidl_typesupport_introspection_c__DummyRecovery_GetResult_service_type_support_handle = {
  0,
  &nav2_msgs__action__dummy_recovery__rosidl_typesupport_introspection_c__DummyRecovery_GetResult_service_members,
  get_service_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nav2_msgs, action, DummyRecovery_GetResult)() {
  if (!nav2_msgs__action__dummy_recovery__rosidl_typesupport_introspection_c__DummyRecovery_GetResult_service_type_support_handle.typesupport_identifier) {
    nav2_msgs__action__dummy_recovery__rosidl_typesupport_introspection_c__DummyRecovery_GetResult_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)nav2_msgs__action__dummy_recovery__rosidl_typesupport_introspection_c__DummyRecovery_GetResult_service_type_support_handle.data;
  ...
  return &nav2_msgs__action__dummy_recovery__rosidl_typesupport_introspection_c__DummyRecovery_GetResult_service_type_support_handle;
}
