...
#ifndef DWB_MSGS__SRV__GET_CRITIC_SCORE__TYPE_SUPPORT_H_
#define DWB_MSGS__SRV__GET_CRITIC_SCORE__TYPE_SUPPORT_H_
...
#endif  // DWB_MSGS__SRV__GET_CRITIC_SCORE__TYPE_SUPPORT_H_
