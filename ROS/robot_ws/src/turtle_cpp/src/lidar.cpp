...
//       "/scan", qos, std::bind(&Lidar::scan_callback, this, std::placeholders::_1));
//   }

// private:
//   void scan_callback(const sensor_msgs::msg::LaserScan::SharedPtr msg)
//   {
//     std::cout << "Received " << msg->ranges.size() << " laser scan range values:" << std::endl;
...
//         "/scan", qos_profile,
//         std::bind(&Lidar::sub_callback, this, std::placeholders::_1));
//   }
// private:
//   void sub_callback(const sensor_msgs::msg::LaserScan::SharedPtr msg) const{
