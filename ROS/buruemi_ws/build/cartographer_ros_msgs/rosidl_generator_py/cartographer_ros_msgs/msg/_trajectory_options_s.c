...
bool cartographer_ros_msgs__msg__trajectory_options__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // tracking_frame
    ...
    rosidl_generator_c__String__assign(&ros_message->tracking_frame, PyBytes_AS_STRING(encoded_field));
  ...
  {  // published_frame
    ...
    rosidl_generator_c__String__assign(&ros_message->published_frame, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // odom_frame
    ...
    rosidl_generator_c__String__assign(&ros_message->odom_frame, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // provide_odom_frame
  ...
  {  // trajectory_builder_options_proto
    ...
    rosidl_generator_c__String__assign(&ros_message->trajectory_builder_options_proto, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
