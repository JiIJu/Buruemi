...
#ifndef CARTOGRAPHER_ROS_MSGS__MSG__SUBMAP_TEXTURE__STRUCT_HPP_
#define CARTOGRAPHER_ROS_MSGS__MSG__SUBMAP_TEXTURE__STRUCT_HPP_
...
struct SubmapTexture_
{
  ...
  explicit SubmapTexture_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : slice_pose(_init)
  {
  ...
  explicit SubmapTexture_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // CARTOGRAPHER_ROS_MSGS__MSG__SUBMAP_TEXTURE__STRUCT_HPP_
