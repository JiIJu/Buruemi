...
#ifndef CARTOGRAPHER_ROS_MSGS__MSG__STATUS_RESPONSE__STRUCT_HPP_
#define CARTOGRAPHER_ROS_MSGS__MSG__STATUS_RESPONSE__STRUCT_HPP_
...
struct StatusResponse_
{
  ...
  explicit StatusResponse_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit StatusResponse_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : message(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // CARTOGRAPHER_ROS_MSGS__MSG__STATUS_RESPONSE__STRUCT_HPP_
