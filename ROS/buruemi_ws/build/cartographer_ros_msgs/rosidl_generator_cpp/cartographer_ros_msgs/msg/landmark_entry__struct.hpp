...
#ifndef CARTOGRAPHER_ROS_MSGS__MSG__LANDMARK_ENTRY__STRUCT_HPP_
#define CARTOGRAPHER_ROS_MSGS__MSG__LANDMARK_ENTRY__STRUCT_HPP_
...
struct LandmarkEntry_
{
  ...
  explicit LandmarkEntry_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  ...
  explicit LandmarkEntry_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : id(_alloc),
...
#endif  // CARTOGRAPHER_ROS_MSGS__MSG__LANDMARK_ENTRY__STRUCT_HPP_
