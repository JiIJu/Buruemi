...
#ifndef CARTOGRAPHER_ROS_MSGS__MSG__STATUS_CODE__STRUCT_HPP_
#define CARTOGRAPHER_ROS_MSGS__MSG__STATUS_CODE__STRUCT_HPP_
...
struct StatusCode_
{
  ...
  explicit StatusCode_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit StatusCode_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // CARTOGRAPHER_ROS_MSGS__MSG__STATUS_CODE__STRUCT_HPP_
