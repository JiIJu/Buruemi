...
#ifndef CARTOGRAPHER_ROS_MSGS__SRV__SUBMAP_QUERY__STRUCT_HPP_
#define CARTOGRAPHER_ROS_MSGS__SRV__SUBMAP_QUERY__STRUCT_HPP_
...
struct SubmapQuery_Request_
{
  ...
  explicit SubmapQuery_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit SubmapQuery_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
// Member 'textures'
#include "cartographer_ros_msgs/msg/submap_texture__struct.hpp"
...
struct SubmapQuery_Response_
{
  ...
  explicit SubmapQuery_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : status(_init)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
  ...
  explicit SubmapQuery_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : status(_alloc, _init)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // CARTOGRAPHER_ROS_MSGS__SRV__SUBMAP_QUERY__STRUCT_HPP_
