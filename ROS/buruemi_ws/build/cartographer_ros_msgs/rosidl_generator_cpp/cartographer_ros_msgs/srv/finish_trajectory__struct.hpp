...
#ifndef CARTOGRAPHER_ROS_MSGS__SRV__FINISH_TRAJECTORY__STRUCT_HPP_
#define CARTOGRAPHER_ROS_MSGS__SRV__FINISH_TRAJECTORY__STRUCT_HPP_
...
struct FinishTrajectory_Request_
{
  ...
  explicit FinishTrajectory_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit FinishTrajectory_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
struct FinishTrajectory_Response_
{
  ...
  explicit FinishTrajectory_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : status(_init)
  {
    (void)_init;
  }

  explicit FinishTrajectory_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : status(_alloc, _init)
  {
    (void)_init;
  }
...
#endif  // CARTOGRAPHER_ROS_MSGS__SRV__FINISH_TRAJECTORY__STRUCT_HPP_
