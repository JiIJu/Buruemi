...
#ifndef CARTOGRAPHER_ROS_MSGS__SRV__WRITE_STATE__STRUCT_HPP_
#define CARTOGRAPHER_ROS_MSGS__SRV__WRITE_STATE__STRUCT_HPP_
...
struct WriteState_Request_
{
  ...
  explicit WriteState_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit WriteState_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : filename(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
struct WriteState_Response_
{
  ...
  explicit WriteState_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : status(_init)
  {
    (void)_init;
  }

  explicit WriteState_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : status(_alloc, _init)
  {
    (void)_init;
  }
...
#endif  // CARTOGRAPHER_ROS_MSGS__SRV__WRITE_STATE__STRUCT_HPP_
