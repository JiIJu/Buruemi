...
#ifndef CARTOGRAPHER_ROS_MSGS__SRV__START_TRAJECTORY__STRUCT_HPP_
#define CARTOGRAPHER_ROS_MSGS__SRV__START_TRAJECTORY__STRUCT_HPP_
...
struct StartTrajectory_Request_
{
  ...
  explicit StartTrajectory_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : options(_init),
    topics(_init)
  {
    (void)_init;
  ...
  explicit StartTrajectory_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
struct StartTrajectory_Response_
{
  ...
  explicit StartTrajectory_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : status(_init)
  {
  ...
  explicit StartTrajectory_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : status(_alloc, _init)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // CARTOGRAPHER_ROS_MSGS__SRV__START_TRAJECTORY__STRUCT_HPP_
