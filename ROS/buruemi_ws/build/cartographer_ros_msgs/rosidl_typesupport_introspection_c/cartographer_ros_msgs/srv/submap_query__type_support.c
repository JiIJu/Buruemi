...
#include <stddef.h>
#include "cartographer_ros_msgs/srv/submap_query__rosidl_typesupport_introspection_c.h"
...
// Member `textures`
#include "cartographer_ros_msgs/msg/submap_texture__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__ServiceMembers cartographer_ros_msgs__srv__submap_query__rosidl_typesupport_introspection_c__SubmapQuery_service_members = {
  "cartographer_ros_msgs__srv",  // service namespace
  "SubmapQuery",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // cartographer_ros_msgs__srv__submap_query__rosidl_typesupport_introspection_c__SubmapQuery_Request_message_type_support_handle,
  NULL  // response message
  // cartographer_ros_msgs__srv__submap_query__rosidl_typesupport_introspection_c__SubmapQuery_Response_message_type_support_handle
};

static rosidl_service_type_support_t cartographer_ros_msgs__srv__submap_query__rosidl_typesupport_introspection_c__SubmapQuery_service_type_support_handle = {
  0,
  &cartographer_ros_msgs__srv__submap_query__rosidl_typesupport_introspection_c__SubmapQuery_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cartographer_ros_msgs, srv, SubmapQuery)() {
  if (!cartographer_ros_msgs__srv__submap_query__rosidl_typesupport_introspection_c__SubmapQuery_service_type_support_handle.typesupport_identifier) {
    cartographer_ros_msgs__srv__submap_query__rosidl_typesupport_introspection_c__SubmapQuery_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)cartographer_ros_msgs__srv__submap_query__rosidl_typesupport_introspection_c__SubmapQuery_service_type_support_handle.data;
  ...
  return &cartographer_ros_msgs__srv__submap_query__rosidl_typesupport_introspection_c__SubmapQuery_service_type_support_handle;
}
