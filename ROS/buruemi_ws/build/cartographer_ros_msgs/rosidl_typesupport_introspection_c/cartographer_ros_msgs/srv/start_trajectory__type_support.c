...
#include <stddef.h>
#include "cartographer_ros_msgs/srv/start_trajectory__rosidl_typesupport_introspection_c.h"
...
// Member `topics`
#include "cartographer_ros_msgs/msg/sensor_topics__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__ServiceMembers cartographer_ros_msgs__srv__start_trajectory__rosidl_typesupport_introspection_c__StartTrajectory_service_members = {
  "cartographer_ros_msgs__srv",  // service namespace
  "StartTrajectory",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // cartographer_ros_msgs__srv__start_trajectory__rosidl_typesupport_introspection_c__StartTrajectory_Request_message_type_support_handle,
  NULL  // response message
  // cartographer_ros_msgs__srv__start_trajectory__rosidl_typesupport_introspection_c__StartTrajectory_Response_message_type_support_handle
};

static rosidl_service_type_support_t cartographer_ros_msgs__srv__start_trajectory__rosidl_typesupport_introspection_c__StartTrajectory_service_type_support_handle = {
  0,
  &cartographer_ros_msgs__srv__start_trajectory__rosidl_typesupport_introspection_c__StartTrajectory_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cartographer_ros_msgs, srv, StartTrajectory)() {
  if (!cartographer_ros_msgs__srv__start_trajectory__rosidl_typesupport_introspection_c__StartTrajectory_service_type_support_handle.typesupport_identifier) {
    cartographer_ros_msgs__srv__start_trajectory__rosidl_typesupport_introspection_c__StartTrajectory_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)cartographer_ros_msgs__srv__start_trajectory__rosidl_typesupport_introspection_c__StartTrajectory_service_type_support_handle.data;
  ...
  return &cartographer_ros_msgs__srv__start_trajectory__rosidl_typesupport_introspection_c__StartTrajectory_service_type_support_handle;
}
