...
{
  cartographer_ros_msgs__srv__SubmapQuery_Request__Sequence * array = (cartographer_ros_msgs__srv__SubmapQuery_Request__Sequence *)malloc(sizeof(cartographer_ros_msgs__srv__SubmapQuery_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  cartographer_ros_msgs__srv__SubmapQuery_Response__Sequence * array = (cartographer_ros_msgs__srv__SubmapQuery_Response__Sequence *)malloc(sizeof(cartographer_ros_msgs__srv__SubmapQuery_Response__Sequence));
  if (!array) {
    return NULL;
  }
