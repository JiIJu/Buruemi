...
cartographer_ros_msgs__msg__TrajectoryOptions__init(cartographer_ros_msgs__msg__TrajectoryOptions * msg)
{
  ...
  // tracking_frame
  if (!rosidl_generator_c__String__init(&msg->tracking_frame)) {
    cartographer_ros_msgs__msg__TrajectoryOptions__fini(msg);
    return false;
  }
  // published_frame
  if (!rosidl_generator_c__String__init(&msg->published_frame)) {
    cartographer_ros_msgs__msg__TrajectoryOptions__fini(msg);
    return false;
  }
  // odom_frame
  if (!rosidl_generator_c__String__init(&msg->odom_frame)) {
    cartographer_ros_msgs__msg__TrajectoryOptions__fini(msg);
    return false;
  }
  // provide_odom_frame
  ...
  if (!rosidl_generator_c__String__init(&msg->trajectory_builder_options_proto)) {
    cartographer_ros_msgs__msg__TrajectoryOptions__fini(msg);
    return false;
  }
  return true;
