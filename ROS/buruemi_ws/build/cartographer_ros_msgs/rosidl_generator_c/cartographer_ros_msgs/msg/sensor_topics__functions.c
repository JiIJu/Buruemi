...
cartographer_ros_msgs__msg__SensorTopics__init(cartographer_ros_msgs__msg__SensorTopics * msg)
{
  ...
  // laser_scan_topic
  if (!rosidl_generator_c__String__init(&msg->laser_scan_topic)) {
    cartographer_ros_msgs__msg__SensorTopics__fini(msg);
    return false;
  }
  // multi_echo_laser_scan_topic
  if (!rosidl_generator_c__String__init(&msg->multi_echo_laser_scan_topic)) {
    cartographer_ros_msgs__msg__SensorTopics__fini(msg);
    return false;
  }
  // point_cloud2_topic
  if (!rosidl_generator_c__String__init(&msg->point_cloud2_topic)) {
    cartographer_ros_msgs__msg__SensorTopics__fini(msg);
    return false;
  }
  // imu_topic
  if (!rosidl_generator_c__String__init(&msg->imu_topic)) {
    cartographer_ros_msgs__msg__SensorTopics__fini(msg);
    return false;
  }
  // odometry_topic
  if (!rosidl_generator_c__String__init(&msg->odometry_topic)) {
    cartographer_ros_msgs__msg__SensorTopics__fini(msg);
    return false;
  }
  // nav_sat_fix_topic
  if (!rosidl_generator_c__String__init(&msg->nav_sat_fix_topic)) {
    cartographer_ros_msgs__msg__SensorTopics__fini(msg);
    return false;
  }
  // landmark_topic
  if (!rosidl_generator_c__String__init(&msg->landmark_topic)) {
    cartographer_ros_msgs__msg__SensorTopics__fini(msg);
    return false;
  }
  return true;
...
cartographer_ros_msgs__msg__SensorTopics__fini(cartographer_ros_msgs__msg__SensorTopics * msg)
{
  ...
  // laser_scan_topic
  rosidl_generator_c__String__fini(&msg->laser_scan_topic);
  // multi_echo_laser_scan_topic
  rosidl_generator_c__String__fini(&msg->multi_echo_laser_scan_topic);
  // point_cloud2_topic
  rosidl_generator_c__String__fini(&msg->point_cloud2_topic);
  // imu_topic
  rosidl_generator_c__String__fini(&msg->imu_topic);
  // odometry_topic
  rosidl_generator_c__String__fini(&msg->odometry_topic);
  // nav_sat_fix_topic
  rosidl_generator_c__String__fini(&msg->nav_sat_fix_topic);
  // landmark_topic
  rosidl_generator_c__String__fini(&msg->landmark_topic);
}
