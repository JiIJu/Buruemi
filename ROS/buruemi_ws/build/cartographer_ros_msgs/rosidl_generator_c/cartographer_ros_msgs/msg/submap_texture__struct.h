...
#ifndef CARTOGRAPHER_ROS_MSGS__MSG__SUBMAP_TEXTURE__STRUCT_H_
#define CARTOGRAPHER_ROS_MSGS__MSG__SUBMAP_TEXTURE__STRUCT_H_
...
{
  rosidl_generator_c__uint8__Sequence cells;
  int32_t width;
  int32_t height;
  double resolution;
...
#endif  // CARTOGRAPHER_ROS_MSGS__MSG__SUBMAP_TEXTURE__STRUCT_H_
