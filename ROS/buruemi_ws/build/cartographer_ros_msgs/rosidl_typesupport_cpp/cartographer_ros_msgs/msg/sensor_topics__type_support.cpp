...
static const _SensorTopics_type_support_symbol_names_t _SensorTopics_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cartographer_ros_msgs, msg, SensorTopics)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cartographer_ros_msgs, msg, SensorTopics)),
  }
};
...
{
  return &::cartographer_ros_msgs::msg::rosidl_typesupport_cpp::SensorTopics_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cartographer_ros_msgs, msg, SensorTopics)() {
  return get_message_type_support_handle<cartographer_ros_msgs::msg::SensorTopics>();
}
