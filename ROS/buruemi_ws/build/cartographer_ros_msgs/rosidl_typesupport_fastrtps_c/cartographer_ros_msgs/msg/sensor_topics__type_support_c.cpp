...
#include "cartographer_ros_msgs/msg/sensor_topics__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_generator_c/string.h"  // imu_topic, landmark_topic, laser_scan_topic, multi_echo_laser_scan_topic, nav_sat_fix_topic, odometry_topic, point_cloud2_topic
#include "rosidl_generator_c/string_functions.h"  // imu_topic, landmark_topic, laser_scan_topic, multi_echo_laser_scan_topic, nav_sat_fix_topic, odometry_topic, point_cloud2_topic
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->laser_scan_topic;
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->multi_echo_laser_scan_topic;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->point_cloud2_topic;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->imu_topic;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->odometry_topic;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->nav_sat_fix_topic;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->landmark_topic;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: laser_scan_topic
  {
    ...
    if (!ros_message->laser_scan_topic.data) {
      rosidl_generator_c__String__init(&ros_message->laser_scan_topic);
    }
  ...
  // Field name: multi_echo_laser_scan_topic
  {
    ...
    if (!ros_message->multi_echo_laser_scan_topic.data) {
      rosidl_generator_c__String__init(&ros_message->multi_echo_laser_scan_topic);
    }
    bool succeeded = rosidl_generator_c__String__assign(
  ...
  // Field name: point_cloud2_topic
  {
    ...
    if (!ros_message->point_cloud2_topic.data) {
      rosidl_generator_c__String__init(&ros_message->point_cloud2_topic);
    }
    bool succeeded = rosidl_generator_c__String__assign(
  ...
  // Field name: imu_topic
  {
    ...
    if (!ros_message->imu_topic.data) {
      rosidl_generator_c__String__init(&ros_message->imu_topic);
    }
    bool succeeded = rosidl_generator_c__String__assign(
  ...
  // Field name: odometry_topic
  {
    ...
    if (!ros_message->odometry_topic.data) {
      rosidl_generator_c__String__init(&ros_message->odometry_topic);
    }
    bool succeeded = rosidl_generator_c__String__assign(
  ...
  // Field name: nav_sat_fix_topic
  {
    ...
    if (!ros_message->nav_sat_fix_topic.data) {
      rosidl_generator_c__String__init(&ros_message->nav_sat_fix_topic);
    }
    bool succeeded = rosidl_generator_c__String__assign(
  ...
  // Field name: landmark_topic
  {
    ...
    if (!ros_message->landmark_topic.data) {
      rosidl_generator_c__String__init(&ros_message->landmark_topic);
    }
    bool succeeded = rosidl_generator_c__String__assign(
