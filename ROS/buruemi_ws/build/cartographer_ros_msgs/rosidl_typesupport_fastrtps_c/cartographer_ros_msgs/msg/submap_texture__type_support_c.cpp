...
#include "cartographer_ros_msgs/msg/submap_texture__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/pose__functions.h"  // slice_pose
#include "rosidl_generator_c/primitives_sequence.h"  // cells
#include "rosidl_generator_c/primitives_sequence_functions.h"  // cells
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: cells
  {
    ...
    if (ros_message->cells.data) {
      rosidl_generator_c__uint8__Sequence__fini(&ros_message->cells);
    }
    if (!rosidl_generator_c__uint8__Sequence__init(&ros_message->cells, size)) {
