...
#include "cartographer_ros_msgs/msg/trajectory_options__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_generator_c/string.h"  // odom_frame, published_frame, tracking_frame, trajectory_builder_options_proto
#include "rosidl_generator_c/string_functions.h"  // odom_frame, published_frame, tracking_frame, trajectory_builder_options_proto
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->tracking_frame;
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->published_frame;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->odom_frame;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->trajectory_builder_options_proto;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: tracking_frame
  {
    ...
    if (!ros_message->tracking_frame.data) {
      rosidl_generator_c__String__init(&ros_message->tracking_frame);
    }
  ...
  // Field name: published_frame
  {
    ...
    if (!ros_message->published_frame.data) {
      rosidl_generator_c__String__init(&ros_message->published_frame);
    }
    bool succeeded = rosidl_generator_c__String__assign(
  ...
  // Field name: odom_frame
  {
    ...
    if (!ros_message->odom_frame.data) {
      rosidl_generator_c__String__init(&ros_message->odom_frame);
    }
    bool succeeded = rosidl_generator_c__String__assign(
  ...
  // Field name: trajectory_builder_options_proto
  {
    ...
    if (!ros_message->trajectory_builder_options_proto.data) {
      rosidl_generator_c__String__init(&ros_message->trajectory_builder_options_proto);
    }
    bool succeeded = rosidl_generator_c__String__assign(
